...
KeyFrame& KeyFrame::operator=(const KeyFrame &rhs)
{
  ...
  Camera             =    rhs.Camera;
  scale_factor_key_frame =  rhs.scale_factor_key_frame;//modified Loianno
...
/////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////modified Loianno////////////////////////////////////////////////
	...
	void (*pFASTFunc)(const CVD::BasicImage<CVD::byte> &, std::vector<CVD::ImageRef> &,int)=NULL;
		//ParamsAccess Params;
		PTAMM_RGBD_cooperative::PtammParamsConfig* pPars = ParamsAccess::varParams;
...
////////////////////////////////modified Loianno//////////////////////////////////////////
    //  if(i == 0)
    //	  agast::agast7_12d::agast_corner_detect12d(lev.im, lev.vCorners, 10);
     //   if(i == 1)
     //   	agast::agast7_12d::agast_corner_detect12d(lev.im, lev.vCorners, 15);
      // if(i == 2)
       // 	agast::agast7_12d::agast_corner_detect12d(lev.im, lev.vCorners, 15);
       //if(i == 3)
       // 	agast::agast7_12d::agast_corner_detect12d(lev.im, lev.vCorners, 10);
...
void KeyFrame::MakeKeyFrame_Rest()
{
 // static gvar3<double> gvdCandidateMinSTScore("MapMaker.CandidateMinShiTomasiScore", 70, SILENT);
  ...
  //////////////////////////////////////modified Loianno/////////////////////////////////////////
  static gvar3<double> gvdCandidateMinSTScore("MapMaker.CandidateMinShiTomasiScore",  ParamsAccess::fixParams->CandidateMinShiTomasiScore, SILENT);
  ///////////////////////////////////////////////////////////////////////////////////////////////
  // For each level...
