...
void CameraCalibrator::imageCallback(const sensor_msgs::ImageConstPtr & img)
 {
    ...
    //mVideoSource.mirSize = CVD::ImageRef(ParamsAccess::fixParams->image_width, ParamsAccess::fixParams->image_height);
    //mVideoSource.mCurrentImage.resize(CVD::ImageRef(ParamsAccess::fixParams->image_width, ParamsAccess::fixParams->image_height));
	initialization = true;
	////////////////////////////////////////////////////////////////////////////////
     Image<Rgb<CVD::byte> > imFrameRGB(CVD::ImageRef(ParamsAccess::fixParams->image_width, ParamsAccess::fixParams->image_height));
     Image<CVD::byte>  imFrameBW(CVD::ImageRef(ParamsAccess::fixParams->image_width, ParamsAccess::fixParams->image_height));

     // Grab new video frame...
     CVD::copy(img_tmp, imFrameBW);
     CVD::copy(img_tmp, imFrameRGB);
...
:mGLWindow(CVD::ImageRef(ParamsAccess::fixParams->image_width, ParamsAccess::fixParams->image_height), "Camera Calibrator"), mCamera("Camera")//modified Loianno
{
	////////////////////////////modified Loianno/////////////////////////////////////
	image_transport::ImageTransport it(nh);
	mImageSub = it.subscribe("/xtion/rgb/image_rect", 1, &CameraCalibrator::imageCallback, this);
