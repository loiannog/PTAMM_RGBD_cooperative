...
Bundle::Bundle()
{
  ...
  //////////////////////////modified Loianno///////////////////////////////////
  GV3::Register(mgvnMaxIterations, "Bundle.MaxIterations", ParamsAccess::varParams->MaxIterations,  SILENT);
  GV3::Register(mgvdUpdateConvergenceLimit, "Bundle.UpdateSquaredConvergenceLimit", ParamsAccess::varParams->UpdateSquaredConvergenceLimit, SILENT);
  ////////////////////////////////////////////////////////////////////////////
...
int Bundle::Compute(bool *pbAbortSignal)
{
  ...
  static gvar3<string> gvsMEstimator("BundleMEstimator", ParamsAccess::fixParams->BundleMEstimator, SILENT);
...
bool Bundle::Do_LM_Step(bool *pbAbortSignal)
{
  ...
  //////////////////////////modified Loianno///////////////////////////
  static gvar3<double> gvdMinSigma("Bundle.MinTukeySigma",   ParamsAccess::fixParams->MinTukeySigma, SILENT);
 //////////////////////////////////////////////////////////////////////
