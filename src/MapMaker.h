...
class MapMaker : protected CVD::Thread
{
  public:
    ...
    bool InitFromStereoDepth(KeyFrame &kFirst,
            std::vector<CVD::ImageRef> &vMatches,  pcl::PointCloud<pcl::PointXYZ> &pt,
            SE3<> &se3CameraPos);
    ...
    void ApplyGlobalScaleToMap(double dScale);//modified Loianno
  protected:
