...
GLWindowMenu::GLWindowMenu(string sName, string sTitle)
{
  ...
  ////////////////////////modified Loianno//////////////////////////////////////
  GV2.Register(mgvnMenuItemWidth, msName+".MenuItemWidth", ParamsAccess::fixParams->mgvnMenuItemWidth, HIDDEN | SILENT);
  GV2.Register(mgvnMenuTextOffset, msName+".MenuTextOffset", ParamsAccess::fixParams->mgvnMenuTextOffset, HIDDEN | SILENT);
  GV2.Register(mgvnEnabled, msName+".Enabled", (int)ParamsAccess::fixParams->mgvnEnabled, HIDDEN | SILENT);
